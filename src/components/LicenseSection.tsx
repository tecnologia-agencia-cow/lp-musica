  ...
  return (
    <section id="para-quem-e" className="py-32 bg-[#110D26] text-white">
      <div className="container mx-auto px-4 max-w-5xl">
        <h2 className="text-4xl md:text-[64px] font-bold text-center mb-16 leading-tight">
          Para quem é
        </h2>
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          className="relative bg-[#1C1638] rounded-r-[16px] overflow-hidden mb-8 flex flex-col md:flex-row mx-auto max-w-[936px] min-h-[384px]"
        >
          {/* Accent Stripe */}
          <div className="w-[6px] bg-[#A78BFA] shrink-0" />
          
          <div className="p-8 md:p-[56px] flex-1 flex flex-col justify-center">
            <h3 className="text-2xl md:text-[32px] font-bold mb-6 leading-tight">
              Operadores de rádio indoor e mídia ambiente
            </h3>
            <p className="text-white/70 text-lg md:text-[20px] leading-relaxed md:leading-[28px] mb-6 font-normal">
            ...
            <p className="text-[#FFFFFF] font-bold text-lg md:text-[20px] leading-relaxed md:leading-[28px] mb-10">
